...
<div id="wrapper" >
	...
	<s:set name="url" scope="session" value="'/WEB-INF/jsp/acquisti/categoria.jsp'"/>
	...
	<div class="row">
		<div class=" col-md-8 col-md-offset-2">
			<div class="alert alert-info text-center text-primary">
				<h4><s:property value="#attr.categoria"/></h4>
			</div>
		</div>
	</div>
	</div>
	...
	<div class="container-fluid text-center" > 
    	<form action="orderBy"> 
    		<s:select name="orderCat" list="#{1:'nome', 2:'marca', 4:'prezzo'}"/>
	...
	<s:iterator value="#attr.magazzinoList" var="art" status="counter">
		<s:if test="pezzi >=0">
	...
	<div>
	  <ul class="pagination">
	  	<s:if test="#attr.counter > 1">
	  		<s:url action="goToCategoria.action" var="nextPage" >
	    ...
	    <li class="active">
	    	<s:url action="goToCategoria.action" var="nextPage" >
				   ...
				   <s:param name="next" value="0"/> 
	                    ...
	                    <s:a href="%{nextPage}"><s:property value="#attr.counter"/></s:a>
	    </li> <!-- +1 a counter -->	
